...
def test_upload_file():
    result1 = s3Bucket.upload_file(b'This is test content', 'testFile.txt')
...
def test_encrpyted_insert():
    result1 = s3Bucket.encrypt_insert(b'test test file for encrpyt', '/test/testFile.txt', "2022-01-22 11:59:00", "Test@example.com", "Test@example.com", "as4sdfskrw34erkwxjkdfh#wsdf#sflh!*7sdfs")
    result2 = s3Bucket.encrypt_insert(file_content=b'test test file for encrpyt', obj_path='/test/testFile2.txt', retDate= "2022-01-22 11:59:00", senderEmail = "", receiverEmail="Test@example.com", encryptKey="as4sdfskrw34erkwxjkdfh#wsdf#sflh!*7sdfs")
    assert result1 == True
    assert result2 == True

def test_get_object_content():
    result = s3Bucket.get_object_content('test/testFile.txt')
